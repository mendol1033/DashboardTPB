...
-- Membuang data untuk tabel appdashboard.historyuser: ~257 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbcapaian: ~1 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbgrupakses: ~20 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbhanggar: ~14 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbiku: ~1 rows (lebih kurang)
DELETE FROM `tbiku`;
...
-- Membuang data untuk tabel appdashboard.tbkodesurat: ~1 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbpegawai: ~177 rows (lebih kurang)
...
-- Membuang data untuk tabel appdashboard.tbuser: ~16 rows (lebih kurang)
DELETE FROM `tbuser`;
...
INSERT INTO `tbuser` (`IdUser`, `NipUser`, `NmUser`, `Password`, `GrupMenu`, `WktRekam`, `PtgsRekam`, `Status`) VALUES
	(30, '197806191999031001', 'sugeng.cahyono', '$2y$09$jBLInAHdq2rODkoWKY5LBOM7Ik5xRyEfL84qtre4j0dqR47f8hem2', 12, '2019-03-14 18:36:35', '199203162014111002', 'Y');
INSERT INTO `tbuser` (`IdUser`, `NipUser`, `NmUser`, `Password`, `GrupMenu`, `WktRekam`, `PtgsRekam`, `Status`) VALUES
...
INSERT INTO `tbuser` (`IdUser`, `NipUser`, `NmUser`, `Password`, `GrupMenu`, `WktRekam`, `PtgsRekam`, `Status`) VALUES
	(55, '197510311998031001', 'haris', '$2y$09$7daKH7y9j1GVnxG8IgWNouPJkQOs/LwnHU23J3s5TvhrdYO0x7VSq', 12, '2019-03-25 08:21:30', '199203162014111002', 'Y');
INSERT INTO `tbuser` (`IdUser`, `NipUser`, `NmUser`, `Password`, `GrupMenu`, `WktRekam`, `PtgsRekam`, `Status`) VALUES
...
-- Membuang data untuk tabel appdashboard.tb_petugas_hanggar: ~4 rows (lebih kurang)
