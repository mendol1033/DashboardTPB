			...
			<div class="col-lg-6 col-md-12 col-xs-12">
				<div class="box" id="Dokumen">
					...
					<div class="box-body" id="DokumenBody">
						...
						<div class="row">
							<?php echo form_open_multipart('#', ' id="form_upload" class="form-inline" enctype="multipart/form-data"'); ?>
							<div class="col-md-8 col-sm-8">
								<?php echo form_upload('data','','id = "data" class="form-control" style="width:100%;"'); ?>
								<span class="help-block"></span>
							</div>
							<div class="col-md-4 col-sm-4">
								<button id="button_upload" type="submit" class="btn btn-success">UPLOAD</button>
							</div>
							<?php echo form_close(); ?>
						</div>
					</div>
...
<!-- 			<div class="col-lg-6 col-md-12 col-xs-12">
				<div class="box" id="Nopen">
					...
					<div class="box-body" id="NopenBody">
						...
						<div class="row">
							<?php echo form_open_multipart('#', ' id="form_uploadNopen" class="form-inline" enctype="multipart/form-data"'); ?>
							<div class="col-md-8 col-sm-8">
		...
		<div class="row">
			<button class="btn btn-info" id="btnCitac">CITAC</button>
		</div>
	</div>
</section>
